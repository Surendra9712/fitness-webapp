...
function ExerciseCard({ ex, onComplete, onRefreshExercise }: { ex: ExerciseItem; onComplete?: (result: {calories_burned: number; exercise_name: string}) => void; onRefreshExercise?: () => void }) {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      localStorage.setItem("smartdiet_exercise_completed", Date.now().toString());
